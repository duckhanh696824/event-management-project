...
const UniversityEvents = () => {
  ...
  const backgroundImages = [
    "/assets/images/banner/sukien1.jpg",
    "/assets/images/banner/sukien2.jpg",
    "/assets/images/banner/sukien3.jpg",
    "/assets/images/banner/sukien4.jpg",
    "/assets/images/banner/sukien5.jpg",
  ];
